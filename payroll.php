<style>
    ...
    #table thead th { background-color: #009688 !important; border-color: #038479 !important; color: #fff !important; }
</style>
				...
				<div class="card">
					<div class="card-header align-items-center d-flex">
						<h4 class="card-title mb-0 flex-grow-1">
							<i class="ri-money-dollar-circle-line me-2 text-primary"></i>Payroll List
						</h4>
						<div class="flex-shrink-0">
							<button type="button" class="btn btn-primary add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#modal">
