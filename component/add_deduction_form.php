		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h6 class="modal-title" id="defaultModalLabel">Create Deduction</h6>
					...
					<div class="row clearfix">
						<div class="col-md-12">
							<div class="form-group">   
								...
								<input type="text" class="form-control" placeholder="Deduction" name="deduction" id="name" data-parsley-required-message="Name is required." required>
							</div>
                            <!-- <div class="form-group">   
